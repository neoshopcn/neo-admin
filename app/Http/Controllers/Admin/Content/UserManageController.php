        ...
        return view('admin.content.users', [
            'neo' => [
                ...
                'columns' => [
                    ...
                    ['prop' => 'avatar_url', 'label' => '头像', 'width' => 80, 'avatar' => true],
                    ['prop' => 'username', 'label' => '账号', 'minWidth' => 120],
                    ['prop' => 'name', 'label' => '姓名', 'minWidth' => 120],
                    ['prop' => 'email', 'label' => '邮箱', 'minWidth' => 160],
                    ['prop' => 'role_names', 'label' => '角色', 'minWidth' => 180],
                    ['prop' => 'google2fa_enabled', 'label' => '双因子', 'width' => 88, 'tag' => true, 'statusLabels' => ['已开启', '未开启']],
                    ['prop' => 'google2fa_lock_label', 'label' => '2FA锁定', 'minWidth' => 200],
                ...
                'perms' => [
                    ...
                    'view' => 'user:view',
                    'extra' => [
                        ['key' => 'resetPwd', 'label' => '重置密码', 'perm' => 'user:reset_password', 'btnType' => 'primary'],
                        ['key' => 'enable2fa', 'label' => '开启双因子', 'perm' => 'user:google2fa_enable', 'when' => ['field' => 'google2fa_enabled', 'equals' => 0], 'btnType' => 'success'],
                        ['key' => 'disable2fa', 'label' => '关闭双因子', 'perm' => 'user:google2fa_disable', 'when' => ['field' => 'google2fa_enabled', 'equals' => 1], 'btnType' => 'danger'],
                        ['key' => 'unlock2fa', 'label' => '解除锁定', 'perm' => 'user:google2fa_unlock', 'when' => ['field' => 'google2fa_is_locked', 'equals' => true], 'btnType' => 'warning'],
                    ],
                ],
            ],
        ]);
